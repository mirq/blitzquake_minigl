...
#if !defined(PPCASM) && !defined(M68KASM) && !defined(GLM68KASM) && !defined(GLPPCASM)
...
#if !defined(GLM68KASM) && !defined(M68KASM) 
...
#if !defined(GLM68KASM) && !defined(GLPPCASM) && !defined(M68KASM) && !defined(PPCASM)
