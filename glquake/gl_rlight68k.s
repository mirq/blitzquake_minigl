**
** Quake for AMIGA
** gl_rlight.c assembler implementations by Frank Wille <frank@phoenix.owl.de>
**

		INCLUDE	"glquakedef68k.i"
...
*        lightplane = plane;
		...
		fmove.s	fp2,(a1)+
		fmove.s	fp3,(a1)
		move.l	NODE_PLANE(a3),_lightplane
