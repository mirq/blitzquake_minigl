...
struct Library *SocketBase = NULL; //moved because of GCC problem
...
#else
unsigned long __stack = 0xC0000;  /* program requires 768k stack */
#endif
...
//  if (timerport = CreatePort(NULL,0)) {
  ...
  if (i =! COM_CheckParm("-malloc_unaligned")) //Surgeon
