...
#ifdef PROXY //optionally limit client to server packets
cvar_t  cl_deltarecord = {"cl_deltarecord","0"};
...
void CL_SendCmd (void)
{
  ...
  int     seq_hash;
#ifdef PROXY
  static float  pps_balance;    // Tonik 
...
void CL_InitInput (void)
{
  ...
  Cvar_RegisterVariable (&cl_deltarecord);
#endif
}
