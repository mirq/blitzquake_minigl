...
#include "crc.h" //surgeon: macro for CRC_ProcessByte
...
cvar_t gl_subdivide_size = {"gl_subdivide_size", "1024", false};
...
{
  int   i, j, pixels, num, max2, altmax;
  miptex_t  *mt;
  texture_t *tx, *tx2;
  texture_t *anims[10];
...
#define ANIM_CYCLE  2
  // link them all together
    for (j=0 ; j<max2 ; j++)
    {
      ...
      tx2->anim_total = max2 * ANIM_CYCLE;
      tx2->anim_min = j * ANIM_CYCLE;
      tx2->anim_max = (j+1) * ANIM_CYCLE;
      tx2->anim_next = anims[ (j+1)%max2 ];
      if (altmax)
...
void Mod_LoadAliasModel (model_t *mod, void *buffer)
{
  ...
  if (!strcmp(loadmodel->name, "progs/player.mdl") ||
...
#else //indicate geometry cache and more :)

	if (!strcmp(mod->name, "progs/lavaball.mdl"))
		mod->modhint = MOD_LAVABALL; 
	if (!strcmp(mod->name, "progs/bolt.mdl"))
		mod->modhint = MOD_BOLT; 
	else if (!strcmp(mod->name, "progs/bolt2.mdl")) 
		mod->modhint = MOD_BOLT2; 
	else if (!strcmp(mod->name, "progs/bolt3.mdl")) 
		mod->modhint = MOD_BOLT3; 
	else if (!strcmp(mod->name, "progs/spike.mdl"))
		mod->modhint = MOD_NAIL; 
	else if (!strcmp(mod->name, "progs/s_spike.mdl")) 
		mod->modhint = MOD_S_NAIL; 
	else if (!strcmp(mod->name, "progs/missile.mdl"))
		mod->modhint = MOD_MISSILE; 
	...
	else if (!strcmp(mod->name, "progs/g_nail2.mdl")) 
		mod->modhint = MOD_S_NAILGUN; 
	else if (!strcmp(mod->name, "progs/g_nail.mdl")) 
		mod->modhint = MOD_NAILGUN; 
	else if (!strcmp(mod->name, "progs/g_shot.mdl")) 
		mod->modhint = MOD_S_SHOTGUN; 
	...
	else if (!strcmp(mod->name, "progs/h_player.mdl")) 
		mod->modhint = MOD_PLAYERHEAD; 
	else if (!strcmp(mod->name, "progs/gib1.mdl")) 
		mod->modhint = MOD_GIB1; 
	else if (!strcmp(mod->name, "progs/gib2.mdl")) 
		mod->modhint = MOD_GIB2; 
	else if (!strcmp(mod->name, "progs/gib3.mdl")) 
		mod->modhint = MOD_GIB3; 
	else if(!strcmp(mod->name, "progs/eyes.mdl")) 
		mod->modhint = MOD_EYES;
	else if(!strcmp(mod->name, "progs/player.mdl")) 
