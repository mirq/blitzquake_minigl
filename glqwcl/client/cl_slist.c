/* 
	...
	$Id: cl_slist.c,v 1.21 2000/12/30 02:16:36 taniwha Exp $ 
*/ 
...
extern char	com_basedir[MAX_OSPATH];	// surgeon 
...
server_entry_t * 
SL_LoadF (FILE *f, server_entry_t *start) 
...
void 
SL_SaveF (FILE *f, server_entry_t *start) 
{ 
	do { 
