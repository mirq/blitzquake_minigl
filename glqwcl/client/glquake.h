...
extern  int   gl_alpha_format;
	...
	#else
	#define gl_alpha_format GL_RGB5_A1 //better for 16bit
	#endif
#endif
...
//void GL_Bind (int texnum); //Surgeon: macro

#ifdef _WIN32

#define GL_Bind(tnum) {bindTexFunc (GL_TEXTURE_2D, tnum);}

#else

#define GL_Bind(tnum) {glBindTexture(GL_TEXTURE_2D, tnum);}
