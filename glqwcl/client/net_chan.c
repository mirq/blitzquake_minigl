...
#ifndef __PPC__
extern struct Device *TimerBase68k;
#endif
...
/*	if (!TimerBase68k)
	{
		TimerBase68k = (struct Device *)FindName(&SysBase->DeviceList, "timer.device");
	}
 ReadEClock(&eval);
*/
#endif
//  #ifdef __PPC__
  port = ((int)(tv.tv_micro*1000) * time(NULL)) & 0xffff;
//  #else
//  port = ((int)(eval.ev_lo*1000) * time(NULL)) & 0xffff;
//  #endif
#else
