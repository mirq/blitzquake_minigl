/*
odd correction for X-hair and character drawing (game win)
*/
...
void Draw_Character (int x, int y, int num)
{
  ...
  if (y < 0)
  { // clipped
//surgeon start - squeeze lineheight
    if(odd_display)
    drawline = 6 + y;
    else
//surgeon end
...
//surgeon start - black border
//uses Draw_Fill routine to clear tile area with color 0
  extern int bblack;
  byte      *dest;
  unsigned short  *pusdest;
  unsigned    uc;
