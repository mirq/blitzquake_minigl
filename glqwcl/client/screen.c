...
/*int     sb_lines; @@@ already defined in sbar.c */

/* viddef_t  vid; @@@ defined in video driver! */ // global video state
...
//surgeon start
 ...
 else
 {
  ...
  Draw_TileClear (0, y, vid.width, min(5*scr_erase_lines, vid.height - y - 1));
 }
//surgeon end
...
{ 
	...
	if (!scr_clock.value || cl.intermission || cls.demoplayback) 
		return; 
