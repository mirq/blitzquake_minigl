...
# WarpOS support (define WarpOS) (phx,22-May-98)
# Deleted all @__name function pointers for WarpOS. They will be
# created by vlink on demand. (phx,08-Jul-98)
#
...
.else	# ELF
	stwu	r1,-80(r1)
	stmw	r14,8(r1)		# save all non-volatile registers
.endif
